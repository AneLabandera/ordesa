...
var lyr_Ortoimagen_1 = new ol.layer.Tile({
                            source: new ol.source.TileWMS(({
                              url: "https://www.ign.es/wms-inspire/pnoa-ma/leyendas/pnoa-ma.png",
    attributions: ' ',
                              params: {
...
lyr_Vegetacion_2.set('fieldAliases', {'Veg_ESP-NO': 'Veg_ESP-NO', });
lyr_Vegetacion_2.set('fieldImages', {'Veg_ESP-NO': '', });
lyr_Vegetacion_2.set('fieldLabels', {'Veg_ESP-NO': 'inline label', });
